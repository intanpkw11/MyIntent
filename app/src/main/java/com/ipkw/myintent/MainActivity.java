...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void pindahActivityTanpaData() {
        Intent moveIntent = new Intent( MainActivity.this, com.ipkw.myintent.SecondActivity.class);
    ...
    private void pindahActivityData() {
        ...
        Intent moveIntentWithData = new Intent(MainActivity.this, com.ipkw.myintent.SecondActivity.class);
